...
export const SKILL_ICONS = [
  ...
  'express', 'nestjs', 'python', 'django', 'flask', 'fastapi',
  'java', 'spring', 'kotlin', 'go', 'rust', 'c', 'cpp', 'cs',
  'php', 'laravel', 'ruby', 'rails', 'swift', 'dart', 'flutter',
  'html', 'css', 'sass', 'tailwind', 'bootstrap', 'materialui',
  'mongodb', 'mysql', 'postgres', 'redis', 'firebase', 'supabase',
  'aws', 'gcp', 'azure', 'docker', 'kubernetes', 'nginx',
  'git', 'github', 'gitlab', 'bitbucket', 'vscode', 'vim',
  'figma', 'xd', 'ai', 'ps', 'pr', 'blender',
  'linux', 'bash', 'powershell', 'webpack', 'vite', 'rollup',
  'graphql', 'apollo', 'prisma', 'sequelize',
  'jest', 'cypress', 'selenium', 'postman',
  'tensorflow', 'pytorch', 'sklearn', 'opencv',
  'electron', 'tauri', 'unity', 'unreal',
] as const;
