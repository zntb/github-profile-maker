...
function BlockConfigFields({
  ...
  function applyStatsRowCardSlotChange(slotIndex: 0 | 1, value: string) {
        ...
        <>
          ...
          <FieldGroup>
            ...
            <Select
              ...
              onValueChange={(value) => applyStatsRowCardSlotChange(0, value)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <FieldGroup>
            ...
            <Select
              ...
              onValueChange={(value) => applyStatsRowCardSlotChange(1, value)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
