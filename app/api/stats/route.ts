...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
  <style>
    ...
    .stat { font: 400 11px 'Segoe UI', Ubuntu, Sans-Serif; fill: #${theme.text}; }
    .stagger { opacity: 0; animation: fadeInAnimation 0.3s ease-in-out forwards; }
    .rank-text { font: 800 18px 'Segoe UI', Ubuntu, Sans-Serif; fill: #${theme.text}; }
  ...
  ${!options.hideTitle ? `<text x="25" y="25" class="header">${username}'s GitHub Stats</text>` : ''}

  <g transform="translate(25, ${options.hideTitle ? 35 : 55})">
  ...
  <g transform="translate(25, ${options.hideTitle ? 75 : 100})">
  ...
  <g transform="translate(25, ${options.hideTitle ? 95 : 120})">
  ...
  <g transform="translate(25, ${options.hideTitle ? 115 : 140})">
  ...
  ${
    !options.hideRank
      ? `
  <g transform="translate(400, ${options.hideTitle ? 55 : 80})">
    <circle class="rank-circle-inner" cx="0" cy="0" r="30"/>
    <circle class="rank-circle" cx="0" cy="0" r="30" stroke-dasharray="188.4" stroke-dashoffset="50" transform="rotate(-90)"/>
    <text x="0" y="6" text-anchor="middle" class="rank-text">${rank}</text>
  </g>
  `
      : ''
  }
