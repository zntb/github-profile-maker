  ...
  if (token) {
    try {
      ...
      return new NextResponse(
        generateErrorSvg(theme.bg, escapeXml(username), 'Error fetching streak for', {
    ...
    return new NextResponse(
      generateTokenRequiredSvg(theme.bg, escapeXml(username), 'to fetch real streak for', {
        border: theme.border,
        titleColor: theme.currStreak,
